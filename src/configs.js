...
async function configOptions() {
    ...
    if(configOptions.configOption === 'info') {
        ...
        var webType = configs.find(config => config.name === selectedConfig).webType;
        var frontend = configs.find(config => config.name === selectedConfig).frontend;
        var backend = configs.find(config => config.name === selectedConfig).backend;
